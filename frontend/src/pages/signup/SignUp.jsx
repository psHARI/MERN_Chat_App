  ...
  return (
    <div className="flex flex-col items-center justify-center min-w-96 mx-auto">
      ...
      <h1 className='text-3xl font-semibold text-center text-black'>
 					Sign Up <span className='text-purple-700'>Vibely</span>
 				</h1>
         <form onSubmit={handleSubmit}>
					<div>
						...
						<input type='text' placeholder='Hari Acharya' className='w-full input input-bordered  h-10' 
          ...
          <div>
 						...
 						<input type='text' placeholder='hariacharya' className='w-full input input-bordered h-10'
